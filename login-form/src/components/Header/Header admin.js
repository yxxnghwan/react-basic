        ...
        return(
            <header className="gnb_box">
                ...
                <div className="h_nav ct1 af">
                    <div className="logo">
                        <Link to={'/'}><img src={logoImg} height="65px" width="200px" alt="logo"/></Link>
                    </div>
                    ...
                    <ul className="af">
                        ...
                        <li className="menulist">
                            <Link to={'/AdminResearchProject'}>Projects 관리</Link>
                        </li>
                        <li className="menulist">
                            <Link to={'/AdminSoftwareList'}>Tools 관리</Link>
                        </li>
                        <li className="menulist">
                            <Link to={'/AdminDataSourceList'}>Data 관리</Link>
                        </li>
                        {/* 드롭다운 이벤트 */}
                        <li  className="menulist"><Link to={'/floatPopulationList'}>인구 조회</Link>
                        <ul className="gn_2">
                            <li><Link to={'/community/notice'}>공지사항</Link></li>
                        </ul>
                        </li>
                        <li  className="menulist">
                            <Link to={'/SubCodeManage'}>Code 관리</Link>
                        </li>
                    </ul>
                    </nav>
                </div>
